...
class Metaclass_DistanceSensor(type):
    ...
    __constants = {
        ...
        'ROTATION_CUSTOM': 100,
        'DISTANCE_SENSOR_MODE_UNKNOWN': 0,
        'DISTANCE_SENSOR_MODE_RUN': 1,
        'DISTANCE_SENSOR_MODE_DISABLED': 2,
    }
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'DISTANCE_SENSOR_MODE_UNKNOWN': cls.__constants['DISTANCE_SENSOR_MODE_UNKNOWN'],
            'DISTANCE_SENSOR_MODE_RUN': cls.__constants['DISTANCE_SENSOR_MODE_RUN'],
            'DISTANCE_SENSOR_MODE_DISABLED': cls.__constants['DISTANCE_SENSOR_MODE_DISABLED'],
        }
    ...
    @property
    def DISTANCE_SENSOR_MODE_UNKNOWN(self):
        """Message constant 'DISTANCE_SENSOR_MODE_UNKNOWN'."""
        return Metaclass_DistanceSensor.__constants['DISTANCE_SENSOR_MODE_UNKNOWN']

    @property
    def DISTANCE_SENSOR_MODE_RUN(self):
        """Message constant 'DISTANCE_SENSOR_MODE_RUN'."""
        return Metaclass_DistanceSensor.__constants['DISTANCE_SENSOR_MODE_RUN']

    @property
    def DISTANCE_SENSOR_MODE_DISABLED(self):
        """Message constant 'DISTANCE_SENSOR_MODE_DISABLED'."""
        return Metaclass_DistanceSensor.__constants['DISTANCE_SENSOR_MODE_DISABLED']
...
class DistanceSensor(metaclass=Metaclass_DistanceSensor):
    ...
    Constants:
      ...
      ROTATION_CUSTOM
      DISTANCE_SENSOR_MODE_UNKNOWN
      DISTANCE_SENSOR_MODE_RUN
      DISTANCE_SENSOR_MODE_DISABLED
    """
