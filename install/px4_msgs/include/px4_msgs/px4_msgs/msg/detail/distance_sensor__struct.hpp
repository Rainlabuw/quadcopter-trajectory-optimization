...
struct DistanceSensor_
{
  ...
  static constexpr uint8_t ROTATION_CUSTOM =
    100u;
  static constexpr uint8_t DISTANCE_SENSOR_MODE_UNKNOWN =
    0u;
  static constexpr uint8_t DISTANCE_SENSOR_MODE_RUN =
    1u;
  static constexpr uint8_t DISTANCE_SENSOR_MODE_DISABLED =
    2u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DistanceSensor_<ContainerAllocator>::DISTANCE_SENSOR_MODE_UNKNOWN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DistanceSensor_<ContainerAllocator>::DISTANCE_SENSOR_MODE_RUN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DistanceSensor_<ContainerAllocator>::DISTANCE_SENSOR_MODE_DISABLED;
#endif  // __cplusplus < 201703L
