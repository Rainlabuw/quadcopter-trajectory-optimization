...
/// Constant 'DISTANCE_SENSOR_MODE_UNKNOWN'.
/**
  * Unknown mode
 */
enum
{
  px4_msgs__msg__DistanceSensor__DISTANCE_SENSOR_MODE_UNKNOWN = 0
};

/// Constant 'DISTANCE_SENSOR_MODE_RUN'.
/**
  * sensor is running continuosly
 */
enum
{
  px4_msgs__msg__DistanceSensor__DISTANCE_SENSOR_MODE_RUN = 1
};

/// Constant 'DISTANCE_SENSOR_MODE_DISABLED'.
/**
  * sensor is disabled per request
 */
enum
{
  px4_msgs__msg__DistanceSensor__DISTANCE_SENSOR_MODE_DISABLED = 2
};
